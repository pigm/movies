...
public abstract class UseCaseParam<T, U> {
    private final CompositeDisposable compositeDisposable = new CompositeDisposable();

    public void execute(@NonNull U var, UseCaseObserver<T> disposableObserver) {
        Preconditions.checkNotNull(disposableObserver);
        Observable<T> observable = this.createObservableUseCase(var)
    ...
    protected abstract Observable<T> createObservableUseCase(@NonNull U var);
}
